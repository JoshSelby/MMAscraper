...
#' - "pro_matches_" + `` + `` for matches data.
#' - `` + "_fun_gen" for rating function generators.
#' - `` + "_win_prob" for functions that compute win probability.
#' 
#' @return A tibble with columns:
#' - __testType__  : Test type identifier.
#' - __ratingType__  : Rating type identifier.
#' - __dataType__  : Data type identifier.
#' - __k__  : Value of "K factor".
#' - __goodness__  : Value of goodness of fit.
